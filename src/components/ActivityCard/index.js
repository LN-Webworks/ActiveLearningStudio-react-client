          ...
          <>
            ...
            >
              <div className="playimage-update-mobile">
                ...
                />
                {project_type &&
                  <div className='playlist-descritpion'>
                    <div className='playlist-name'>{activity.metadata ? activity.metadata.title : activity.title}</div>
                    ...
                    <div className='playlist-created'>{activity.metadata ? moment(activity.metadata.created_at).fromNow(): moment(activity.created_at).fromNow()}</div> */}
                  </div>
                }
